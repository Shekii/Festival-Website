	   ...
	   <div class="container-fluid" id="navfluid">
	       ...
	       <div class="collapse navbar-collapse" id="navigationbar">
				  <ul class="nav navbar-nav">
					...
					<li><a href="mailto:admin@google.com">Contact Us</a></li>
		<?php
		...
		<?php
			if (isset($_SESSION['login']))
				if ($user->is_user_admin($account[0]['userID'])) {


		?>
			            <li><a href='#'><a href="admin/"><span class="glyphicon glyphicon-briefcase"></span>&nbsp; Admin Panel</a></li>
		<?php	
		}		  
		?>
			            <li><a href="#"><a href="#"><span class="glyphicon glyphicon-question-sign"></span>&nbsp; Help</a></li>
			            <li role="separator" class="divider"></li>
			            <li><a href="#"><a href="#"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp; Basket (0)</a></li>
			            <li role="separator" class="divider"></li>
			            <li><a href="includes/logout.inc.php"><span class="glyphicon glyphicon-off"></span>&nbsp; Sign Out</a></li>
			          </ul>
        			</li>
		<?php
				}
